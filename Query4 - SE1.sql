...
TIT_PIS_VAL = CASE WHEN (SELECT E1_VALOR FROM  SE1010 IE1 WHERE IE1.D_E_L_E_T_='' AND IE1.E1_FILIAL = E1.E1_FILIAL AND  IE1.E1_TIPO IN ('PI-','PIS') AND IE1.E1_PREFIXO = E1.E1_PREFIXO AND IE1.E1_NUM = E1.E1_NUM AND IE1.E1_CLIENTE = E1.E1_CLIENTE AND IE1.E1_PARCELA = E1.E1_PARCELA) IS NULL
	THEN (SELECT MAX(E5_VRETPIS) FROM  SE5010 IE5 WHERE IE5.D_E_L_E_T_='' AND IE5.E5_FILIAL = E1.E1_FILIAL AND  IE5.E5_PREFIXO = E1.E1_PREFIXO AND IE5.E5_NUMERO = E1.E1_NUM AND IE5.E5_CLIENTE = E1.E1_CLIENTE AND IE5.E5_PARCELA = E1.E1_PARCELA AND E1.E1_BAIXA=IE5.E5_DTDISPO   
		AND (E5_MOTBX NOT IN ('PIS','CSL','COF','PI-','CS-','CF-','ISS') AND E5_VRETPIS<>0) AND E5_TIPODOC NOT IN ('DC','ES','BA') AND E5_RECPAG='R' GROUP BY E5_VRETPIS)
...
TIT_COF_VAL = CASE WHEN (SELECT E1_VALOR FROM  SE1010 IE1 WHERE IE1.D_E_L_E_T_='' AND IE1.E1_FILIAL = E1.E1_FILIAL AND  IE1.E1_TIPO IN ('CF-','COF') AND IE1.E1_PREFIXO = E1.E1_PREFIXO AND IE1.E1_NUM = E1.E1_NUM AND IE1.E1_CLIENTE = E1.E1_CLIENTE AND IE1.E1_PARCELA = E1.E1_PARCELA) IS NULL
	THEN (SELECT MAX(E5_VRETCOF) FROM  SE5010 IE5 WHERE IE5.D_E_L_E_T_='' AND IE5.E5_FILIAL = E1.E1_FILIAL AND  IE5.E5_PREFIXO = E1.E1_PREFIXO AND IE5.E5_NUMERO = E1.E1_NUM AND IE5.E5_CLIENTE = E1.E1_CLIENTE AND IE5.E5_PARCELA = E1.E1_PARCELA AND E1.E1_BAIXA=IE5.E5_DTDISPO 
		AND (E5_MOTBX NOT IN ('PIS','CSL','COF','PI-','CS-','CF-','ISS') AND E5_VRETCOF<>0) AND E5_TIPODOC NOT IN ('DC','ES','BA') AND E5_RECPAG='R' GROUP BY E5_VRETCOF)
...
TIT_CSLL_VAL = CASE WHEN (SELECT E1_VALOR FROM  SE1010 IE1 WHERE IE1.D_E_L_E_T_='' AND IE1.E1_FILIAL = E1.E1_FILIAL AND  IE1.E1_TIPO IN ('CS-','CSL') AND IE1.E1_PREFIXO = E1.E1_PREFIXO AND IE1.E1_NUM = E1.E1_NUM AND IE1.E1_CLIENTE = E1.E1_CLIENTE AND IE1.E1_PARCELA = E1.E1_PARCELA) IS NULL
	THEN (SELECT MAX(E5_VRETCSL) FROM  SE5010 IE5 WHERE IE5.D_E_L_E_T_='' AND IE5.E5_FILIAL = E1.E1_FILIAL AND  IE5.E5_PREFIXO = E1.E1_PREFIXO AND IE5.E5_NUMERO = E1.E1_NUM AND IE5.E5_CLIENTE = E1.E1_CLIENTE AND IE5.E5_PARCELA = E1.E1_PARCELA AND E1.E1_BAIXA=IE5.E5_DTDISPO 
		AND (E5_MOTBX NOT IN ('PIS','CSL','COF','PI-','CS-','CF-','ISS') AND E5_VRETCSL<>0) AND E5_TIPODOC NOT IN ('DC','ES','BA') AND E5_RECPAG='R' GROUP BY E5_VRETCSL)
...
INNER JOIN SF2010 F2 WITH(NOLOCK) 
	...
	AND E1_LOJA = F2_LOJA  	
INNER JOIN SE5010 E5N WITH(NOLOCK)
	ON E5N.D_E_L_E_T_='' 	
	AND E1_FILIAL = E5N.E5_FILIAL 
	AND E1_PREFIXO = E5N.E5_PREFIXO 
	AND E1_NUM = E5N.E5_NUMERO 		
	AND E1_CLIENTE = E5N.E5_CLIENTE 
	AND E1_LOJA = E5N.E5_LOJA 		
WHERE E1.D_E_L_E_T_=''   		
AND E1_TIPO  IN ('NF')	
AND E1_FILIAL BETWEEN  '' AND '001NE001'
AND E1_CLIENTE BETWEEN  '' AND 'ZZZZZZ'
AND E1_LOJA BETWEEN  '' AND 'ZZ'
AND E1_BAIXA BETWEEN  '20140801' AND '20140930'
...
IE5.R_E_C_N_O_ = (SELECT MAX(R_E_C_N_O_) FROM  SE5010 IE5 
	WHERE IE5.D_E_L_E_T_='' AND IE5.E5_FILIAL = E1.E1_FILIAL AND  IE5.E5_PREFIXO = E1.E1_PREFIXO 
AND IE5.E5_NUMERO = E1.E1_NUM  AND IE5.E5_CLIENTE = E1.E1_CLIENTE AND IE5.E5_PARCELA = E1.E1_PARCELA AND E1.E1_BAIXA=IE5.E5_DTDISPO 
AND (E5_MOTBX NOT IN ('PIS','CSL','COF','PI-','CS-','CF-','ISS') AND E5_VRETPIS<>0) AND E5_RECPAG='R')) IS NOT NULL))
