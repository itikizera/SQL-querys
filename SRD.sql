...
WHEN FicFin.cvVlrFimFicFin IN (SELECT MAX(FIC3.cvVlrFimFicFin) FROM FicFin AS FIC3
...
WHEN	'0684'	THEN	'Z62' WHEN  '0001' 	THEN 	'657'  ELSE FicFin.cvCodEve END) AS RD_PD, Evento.ccNomEve,
...
WHERE (CONVERT(VARCHAR,FicFin.cvAnoFicFin)+ RIGHT('00' + RTRIM(FicFin.cvMesFicFin),2)) >= '201201'
AND RIGHT(FUN.ccVarFun,7) = '003133' and Evento.ccNomEve LIKE '%PROV%'

-- AND FicFin.cvCodEve IN ('0080', '0081', '0109') --AND FUN.cvCodFil = '47'
