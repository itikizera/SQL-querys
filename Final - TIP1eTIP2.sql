...
AND RIGHT(FUN.ccVarFun,7) NOT IN (SELECT TIP1.RT_MAT FROM PROVTIP1 TIP1
INNER JOIN PROVTIP2 TIP2 ON TIP1.cvCodFil = TIP2.cvCodFil and TIP1.RT_MAT = TIP2.RT_MAT AND TIP1.RT_VERBA = TIP2.RT_VERBA
WHERE TIP1.RT_TIPPROV = '1')
...
WHEN '72' THEN '0A0 - LEVERG' WHEN '74' THEN '0B0 - MINERGOLD' WHEN '75' THEN '0A0 - LEVERG' ELSE '999' END) AS RT_FILIAL, RIGHT(FUN.ccVarFun,7) AS RT_MAT, 
(CASE FicFin.cvCodEve
WHEN	'86'	THEN	'808' ELSE FicFin.cvCodEve END) AS RT_VERBA, FUN.cvSalFun AS SALARIO,
FicFin.cvCodEve,	
Evento.ccNomEve, RT_TIPPROV='1',
FicFin.cvVlrBasFicFin AS RT_HORAS, FicFin.cvVlrFimFicFin AS RT_VALOR,
(CONVERT(VARCHAR,FicFin.cvAnoFicFin)+ RIGHT('00' + RTRIM(FicFin.cvMesFicFin),2)) AS RT_DATACAL,
...
SELECT (CASE TIP1.cvCodFil WHEN '73' THEN '0C0 - EQUIPAV' WHEN '47' THEN '096 - SARPAV' WHEN '71' THEN '0A0 - MINERPAV'
WHEN '72' THEN '0A0 - LEVERG' WHEN '74' THEN '0B0 - MINERGOLD' WHEN '75' THEN '0A0 - LEVERG' ELSE '999' END) AS RT_FILIAL,
 TIP1.RT_MAT, TIP1.RT_VERBA,  SALARIO = '', TIP1.CODEVENTO, TIP1.DESCRI, TIP1.RT_TIPPROV, TIP1.RT_HORAS, TIP1.RT_VALOR-TIP2.RT_VALOR AS RT_VALOR, TIP1.RT_DATACAL, TIP1.RT_CC FROM PROVTIP1 TIP1
LEFT JOIN PROVTIP2 TIP2 ON TIP1.cvCodFil = TIP2.cvCodFil and TIP1.RT_MAT = TIP2.RT_MAT AND TIP1.RT_VERBA = TIP2.RT_VERBA
WHERE TIP1.RT_TIPPROV = '1'  
AND TIP1.RT_MAT IN (SELECT TIP1.RT_MAT FROM PROVTIP1 TIP1
INNER JOIN PROVTIP2 TIP2 ON TIP1.cvCodFil = TIP2.cvCodFil and TIP1.RT_MAT = TIP2.RT_MAT AND TIP1.RT_VERBA = TIP2.RT_VERBA
WHERE TIP1.RT_TIPPROV = '1')
