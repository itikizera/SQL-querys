...
TIT_PIS_VAL = CASE WHEN (SELECT E1_VALOR FROM  SE1010 IE1 WHERE IE1.D_E_L_E_T_='' AND IE1.E1_FILIAL = E1.E1_FILIAL AND  IE1.E1_TIPO IN ('PI-','PIS') AND IE1.E1_PREFIXO = E1.E1_PREFIXO AND IE1.E1_NUM = E1.E1_NUM AND IE1.E1_CLIENTE = E1.E1_CLIENTE AND IE1.E1_PARCELA = E1.E1_PARCELA) IS NULL
	THEN (SELECT MAX(E5_VRETPIS) FROM  SE5010 IE5 WHERE IE5.D_E_L_E_T_='' AND IE5.E5_FILIAL = E1.E1_FILIAL AND  IE5.E5_PREFIXO = E1.E1_PREFIXO AND IE5.E5_NUMERO = E1.E1_NUM AND IE5.E5_CLIENTE = E1.E1_CLIENTE AND IE5.E5_PARCELA = E1.E1_PARCELA 
		AND (E5_MOTBX NOT IN ('PIS','CSL','COF','PI-','CS-','CF-') AND E5_VRETPIS<>0) AND E5_TIPODOC NOT IN ('DC','ES') GROUP BY E5_VRETPIS)
...
TIT_COF_VAL = CASE WHEN (SELECT E1_VALOR FROM  SE1010 IE1 WHERE IE1.D_E_L_E_T_='' AND IE1.E1_FILIAL = E1.E1_FILIAL AND  IE1.E1_TIPO IN ('CF-','COF') AND IE1.E1_PREFIXO = E1.E1_PREFIXO AND IE1.E1_NUM = E1.E1_NUM AND IE1.E1_CLIENTE = E1.E1_CLIENTE AND IE1.E1_PARCELA = E1.E1_PARCELA) IS NULL
	THEN (SELECT MAX(E5_VRETCOF) FROM  SE5010 IE5 WHERE IE5.D_E_L_E_T_='' AND IE5.E5_FILIAL = E1.E1_FILIAL AND  IE5.E5_PREFIXO = E1.E1_PREFIXO AND IE5.E5_NUMERO = E1.E1_NUM AND IE5.E5_CLIENTE = E1.E1_CLIENTE AND IE5.E5_PARCELA = E1.E1_PARCELA
		AND (E5_MOTBX NOT IN ('PIS','CSL','COF','PI-','CS-','CF-') AND E5_VRETCOF<>0) AND E5_TIPODOC NOT IN ('DC','ES') GROUP BY E5_VRETCOF)
...
TIT_CSLL_VAL = CASE WHEN (SELECT E1_VALOR FROM  SE1010 IE1 WHERE IE1.D_E_L_E_T_='' AND IE1.E1_FILIAL = E1.E1_FILIAL AND  IE1.E1_TIPO IN ('CS-','CSL') AND IE1.E1_PREFIXO = E1.E1_PREFIXO AND IE1.E1_NUM = E1.E1_NUM AND IE1.E1_CLIENTE = E1.E1_CLIENTE AND IE1.E1_PARCELA = E1.E1_PARCELA) IS NULL
	THEN (SELECT MAX(E5_VRETCSL) FROM  SE5010 IE5 WHERE IE5.D_E_L_E_T_='' AND IE5.E5_FILIAL = E1.E1_FILIAL AND  IE5.E5_PREFIXO = E1.E1_PREFIXO AND IE5.E5_NUMERO = E1.E1_NUM AND IE5.E5_CLIENTE = E1.E1_CLIENTE AND IE5.E5_PARCELA = E1.E1_PARCELA
		AND (E5_MOTBX NOT IN ('PIS','CSL','COF','PI-','CS-','CF-') AND E5_VRETCSL<>0) AND E5_TIPODOC NOT IN ('DC','ES') GROUP BY E5_VRETCSL)
...
AND E1_BAIXA BETWEEN  '20140806' AND '20140806'
