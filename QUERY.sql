SELECT FUN.cvCodFil AS RT_FILIAL, RIGHT(FUN.ccVarFun,7) AS RT_MAT, 
(CASE FicFin.cvCodEve
WHEN	'67'	THEN	'804' WHEN	'86'	THEN	'808' 
WHEN	'87'	THEN	'806' WHEN	'1279'	THEN	'803'   
	ELSE FicFin.cvCodEve END) AS RT_VERBA, Evento.ccNomEve, RT_TIPPROV='1',
...
WHERE (CONVERT(VARCHAR,FicFin.cvAnoFicFin)+ RIGHT('00' + RTRIM(FicFin.cvMesFicFin),2)) >= '201310'
AND RIGHT(FUN.ccVarFun,7) = '003152' AND FicFin.cvCodEve in ('67','86','87','1279')
