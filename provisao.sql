...
SELECT T.*,ROUND((PROV_MAI - PROV_ABR),2) DIF
 FROM(
SELECT RA_FILIAL,RA_MAT,RA_NOME,RA_CC,RA_ADMISSA,RA_SITFOLH,RA_SALARIO,RA_PERICUL
,ROUND(ISNULL((SELECT SUM(RT_VALOR) FROM SRT010 WHERE D_E_L_E_T_ = '' AND RT_FILIAL = RA_FILIAL AND RA_MAT = RT_MAT AND RT_DATACAL = '20140430' AND RT_VERBA = '950'),0),2) PROV_ABR
,ROUND(ISNULL((SELECT SUM(RT_VALOR) FROM SRT010 WHERE D_E_L_E_T_ = '' AND RT_FILIAL = RA_FILIAL AND RA_MAT = RT_MAT AND RT_DATACAL = '20140531' AND RT_VERBA = '950'),0),2) PROV_MAI
FROM SRA010
WHERE 
    D_E_L_E_T_ = ''
AND RA_SITFOLH <> 'D')T 
WHERE PROV_ABR <> PROV_MAI
